"""Record camera images and odometry while driving TurtleBot3 with teleop."""
...
def simulation_actions(turtlebot3_directory, world_file, robot_model_file, start_pose):
...
def launch_setup(context):
    ...
    robot_model_file = bringup_directory / "models" / "smyd_vint_waffle_pi" / "model.sdf"
    ...
    return [
        ...
        *simulation_actions(turtlebot3_directory, world_file, robot_model_file, START_POSE),
        ExecuteProcess(
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("gui", default_value="true", description="show Gazebo window"),
